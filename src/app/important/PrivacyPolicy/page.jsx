...
import { FileText, Mail, MapPin, Phone, Lock, AlertTriangle, Download } from 'lucide-react'

const PRIVACY_POLICY_PDF_PATH = '/important/Privacy Policy - INDEQNET.pdf'
      ...
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href={encodeURI(PRIVACY_POLICY_PDF_PATH)}
              download="Privacy Policy - INDEQNET.pdf"
            ...
            <p className="text-sm text-slate-400 max-w-xs text-center sm:text-left">
              Save or print the full Privacy Policy document.
            </p>
          </div>
        </div>
      </section>
